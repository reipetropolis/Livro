...
@Using (Html.BeginForm())
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            @Html.DropDownListFor(Function(model) model.Assunto_CodAs, New SelectList(ViewBag.list, "codAs", "Descricao", Model.Assunto_CodAs), "Selecione", New With {.htmlAttributes = New With {.class = "form-control"}})
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            @Html.DropDownListFor(Function(model) model.Autor_CodAu, New SelectList(ViewBag.listAutor, "CodAu", "Nome", Model.Autor_CodAu), "Selecione", New With {.htmlAttributes = New With {.class = "form-control"}})
